...
const ChatBot = () => {
  ...
  const sendMessage = async (prompt) => {
   ...
   // const instructs = "Question: " + prompt+ " Answer: ";
    try {
      setIsLoading(true);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        {/* Add the logo image */}
        <div>
          <h1 className={styles.title}>LlamaChat</h1>
          <p>A simple interface for the Llama2 LLM, using 7b-chat-uncensored-ggml-model-Q4_0 </p>
        </div>
      </div>
